    ...
    <div className="py-8 lg:py-12">
      <div className="px-4 lg:px-6 max-w-6xl mx-auto text-base">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Be at least 16 years old or have parental consent if under 16.
          </li>
          <li>
          ...
          <li>
            Not use our services for any unlawful, harmful, or unauthorized
            purposes, including spamming, fraud, or distributing malicious
            content.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            All activities conducted under your account, whether authorized or
            not.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Provide accurate event details, including date, time, location, and
            ticket pricing.
          </li>
          <li>
            Comply with all applicable laws and regulations related to event
            hosting, including obtaining necessary permits.
          </li>
          <li>
            Honor ticket purchases and refunds as outlined in your event’s
            refund policy, which must be clearly communicated to attendees.
          </li>
          <li>
            Not post content that is offensive, misleading, or violates
            third-party rights (e.g., copyrights or trademarks).
          </li>
        </ul>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Pay any applicable fees for using our services, as outlined during
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Represent that you own or have the necessary rights to submit the
            User Content and that it does not violate any laws or third-party
            rights.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Issues related to events, including cancellations, safety, or
            quality, which are the responsibility of event organizers.
          </li>
          <li>
            Loss of data, revenue, or opportunities resulting from service
        ...
        <p className="mb-4">
          ...
          page, and the updated{" "}
          <span className="font-medium">Effective Date</span> will be noted
          above. Continued use of our services after changes constitutes

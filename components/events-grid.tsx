...
const events = Array.from({ length: 12 }).map((_, i) => ({
  ...
  price: ["$299", "$149", "$79", "Free", "$49", "$399", "$89", "$129", "$199", "$59", "$25", "Free"][i],
  category: [
    "Technology",
    "Music",
    "Food & Drink",
  ...
  attendees: [1200, 5000, 3000, 500, 800, 150, 2500, 1000, 1500, 300, 450, 200][i],
  type: [
    "public-paid",
    "public-paid",
    "public-paid",
              ...
              <div className="relative aspect-[3/2] w-full overflow-hidden">
                ...
                <div className="absolute bottom-3 left-3 flex flex-wrap gap-2">
                  ...
                  <Badge variant="outline" className="bg-black/30 text-white backdrop-blur-sm hover:bg-black/50">
                    {event.type === "public-free" || event.type === "private-free" ? "Free" : event.price}
                  </Badge>
                </div>
              </div>
